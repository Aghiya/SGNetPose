...
from .custom_data_layer import JAAD as CustomDataLayer
import pdb
...
class JAADDataLayer(data.Dataset):
    def __init__(self, args, split):
        ...
        beh_seq = imdb.get_split(split, traj_model_opts['observe_length'] + traj_model_opts['predict_length'], augment_x=True, augment_y=False)
    ...
    def get_data(self, data, **model_opts):
        ...
        ret =  {'obs_image': obs_slices['image'],
                ...
                'obs_bbox_unnormed': obs_slices['bbox_unnormed'],
                'model_opts': opts,
                }
